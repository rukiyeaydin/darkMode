  ...
  return (
    <Parallax blur={5} bgImage={Code} strength={500} className='foto '>
      <div className="prlx flex flex-wrap m-2"> 
        <Link to="advanced" spy={true} smooth={true} offset={-70} duration={1000} className="bir w-72 bg-white flex-col items-center content-center text-center font-black p-1 m-2 rounded-md cursor-pointer">
